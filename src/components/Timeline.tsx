...
const TIMELINE_DATA = [
  {
    ...
    org: "Freelance & College Projects",
    description: "Started building real projects using AI-assisted development. Delivered web apps, Android apps, and college projects for clients and peers across Kerala.",
    type: "work",
  },
  {
    year: "2023 - 2026",
    title: "BCA Graduate",
    org: "M C Varghese College",
    description: "Completed Bachelor of Computer Applications. Built multiple real-world projects including job portals, safety apps, health management systems, and Android apps using Django, Python, Kotlin, and PHP.",
    type: "education",
  },
  {
    year: "2022 - 2023",
    ...
    description: "Completed DHSE 12th standard (State Board). Coding interest grew stronger — started exploring web development and understanding how real applications are built.",
    type: "education",
  },
  {
    year: "2021 - 2022",
    ...
    org: "Holy Cross School",
    description: "Completed DHSE 11th standard (State Board). Had some exposure to programming concepts but hadn't gone deep into it yet.",
    type: "education",
  },
  {
    year: "2021",
    title: "Completed 10th Standard",
    org: "Mangalam English Medium School",
    description: "Completed CBSE 10th standard. Had a little knowledge of basic coding concepts — the first spark that eventually led to a passion for building software.",
    type: "milestone",
  },
];
