    ...
    <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-center text-white mix-blend-difference">
        ...
        >
            <div className="text-center">
                <h1 className="text-6xl md:text-8xl font-bold tracking-tight mb-4">Bimal Jayakumar</h1>
                <p className="text-xl md:text-2xl font-light text-gray-300">Developer. Builder. AI-Powered</p>
            </div>
        </motion.div>
        ...
        >
            <div className="max-w-2xl">
                <h2 className="text-5xl md:text-7xl font-bold leading-tight">Building real apps <br/>with <span className="text-blue-500">AI & code.</span></h2>
            </div>
        </motion.div>
        ...
        >
            <div className="max-w-2xl">
                <h2 className="text-5xl md:text-7xl font-bold leading-tight">From idea to <br/><span className="text-purple-500">deployment,</span> fast.</h2>
            </div>
        </motion.div>
    </div>
  );
